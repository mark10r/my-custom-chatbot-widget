...
const ChatWidget: React.FC<ChatWidgetProps> = ({ 
    ...
    // --- PAGE LEAVE EFFECT (Disabled in Preview) ---
    useEffect(() => {
        const handlePageLeave = () => {
            // Only fire transcript webhook if NOT in preview mode
            ...
            <div className={`chat-window ${isOpen ? 'is-open' : 'is-closed'}`} style={{ borderColor: 'var(--primary-color)' }}>
                <div className="chat-header" style={{ backgroundColor: 'var(--primary-color)' }}>
                    ...
                    <div className="header-info">
                        <h3>{finalTheme.headerTitle} {isPreview && <span style={{fontSize: '10px', opacity: 0.7, marginLeft: '4px'}}>(Preview)</span>}</h3>
