...
// Ensures links generated by the bot open in a new tab
...
const ChatWidget: React.FC<ChatWidgetProps> = ({ 
    ...
    // --- TAB NOTIFICATION RESET LISTENER ---
    useEffect(() => {
        const handleVisibilityChange = () => {
            if (!document.hidden) {
                // Reset title when user returns to the tab
    ...
    // --- WELCOME MESSAGE WITH SOUND AND TAB NOTIFICATION ---
    useEffect(() => {
